...
class ShapeFunction extends StatefulWidget {
  const ShapeFunction(this.shaderPath, {Key? key}) : super(key: key);
  final String shaderPath;

  @override
  State<ShapeFunction> createState() => _ShapeFunctionState();
}

class _ShapeFunctionState extends State<ShapeFunction> {
